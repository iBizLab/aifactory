...
|[团队管理员(user_group_admin)](module/Insight/insight_view/query/user_group_admin)|user_group_admin|否|否 |否 ||
...
| 打开模板选择 | open_choose_template | 打开模板选择 |无数据|<details><summary>打开视图或向导（模态）</summary></details>||
