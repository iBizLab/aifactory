...
state "记录视图参数" as PREPAREJSPARAM_01  [[$./send_comment_wiki#preparejsparam_01 {记录视图参数}]]
...
RAWJSCODE3 --> PREPAREJSPARAM_01
PREPAREJSPARAM_01 --> END1
...
#### 记录视图参数 :id=PREPAREJSPARAM_01<sup class="footnote-symbol"> <font color=gray size=1>[准备参数]</font></sup>



1. 将`true` 设置给  `view(当前视图对象).comment_list_isshow`
