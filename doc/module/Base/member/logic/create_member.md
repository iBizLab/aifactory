...
state "循环输出勾选用户" as DEBUGPARAM_01  [[$./create_member#debugparam_01 {"循环输出勾选用户"}]]
...
RENEWPARAM1 --> DEBUGPARAM_01
DEBUGPARAM_01 --> PREPAREPARAM1
...
#### 循环输出勾选用户 :id=DEBUGPARAM_01<sup class="footnote-symbol"> <font color=gray size=1>[调试逻辑参数]</font></sup>
