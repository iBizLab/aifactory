...
|序号|SEQUENCE|数值||是||
|设置|SETTING|一对一关系数据对象|1048576|是||
...
| -------- |---------- |------------|----- |
|[DER1N_AI_KNOWLEDGE_BASE_CATEGORY_CATEGORY_ID](der/DER1N_AI_KNOWLEDGE_BASE_CATEGORY_CATEGORY_ID)|[知识库(AI_KNOWLEDGE_BASE)](module/ai/ai_knowledge_base)|1:N关系||
...
|[DERCUSTOM_AI_KB_CHUNKING_STRATEGY_CATEGORY](der/DERCUSTOM_AI_KB_CHUNKING_STRATEGY_CATEGORY)|[知识库文档切片策略(AI_KB_CHUNKING_STRATEGY)](module/ai/ai_kb_chunking_strategy)|自定义关系||
|[DERCUSTOM_CATEGORY_SETTINGS_CATEGORY](der/DERCUSTOM_CATEGORY_SETTINGS_CATEGORY)|[类别设置(CATEGORY_SETTINGS)](module/Base/category_settings)|自定义关系||
...
|Get|Get|内置方法|默认|不支持|[附加操作](index/action_logic_index#category_Get)|||
...
|[知识库目录(ai_kb_category)](module/Base/category/query/ai_kb_category)|ai_kb_category|否|否 |否 ||
|[知识库目录（顶级）(ai_kb_category_top)](module/Base/category/query/ai_kb_category_top)|ai_kb_category_top|否|否 |否 ||
...
|[知识库目录(ai_kb_category)](module/Base/category/dataset/ai_kb_category)|ai_kb_category|数据查询|否|||
|[知识库目录（顶级）(ai_kb_category_top)](module/Base/category/dataset/ai_kb_category_top)|ai_kb_category_top|数据查询|否|||
...
| 删除 | toolbar_category_tree_exp_view_node_cm_deuiaction2_click | 删除 |单项数据|用户自定义||
...
| 删除 | toolbar_category_tree_exp_view_node1_cm_deuiaction2_click | 删除 |单项数据|用户自定义||
| 知识库分类设置 | kb_setting | 设置 |单项数据（主键）|<details><summary>打开视图或向导（模态）</summary>[知识库分类设置](app/view/category_kb_setting)</details>||
