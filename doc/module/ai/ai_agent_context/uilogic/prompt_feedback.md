## prompt_feedback <!-- {docsify-ignore-all} -->
...
state "开始" as Begin <<start>> [[$./prompt_feedback#begin {开始}]]
state "注入脚本代码" as RAWJSCODE_01  [[$./prompt_feedback#rawjscode_01 {注入脚本代码}]]
state "结束" as END_01 <<end>> [[$./prompt_feedback#end_01 {结束}]]
