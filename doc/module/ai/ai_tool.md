...
|技能引用资料|SKILL_REFERENCES|一对多动态对象|16777215|是||
|技能脚本集合|SKILL_SCRIPTS|一对多动态对象|16777215|是||
|超时时间|TIMEOUT|整型||是||
...
| -------- |---------- |----------- |:----:|:----:|---------| ----- | ----- |
|建立技能|create_skill|用户扩展建立|默认|不支持||||
...
|[启用的技能数据(SKILL_VALID)](module/ai/ai_tool/query/skill_valid)|SKILL_VALID|否|否 |否 |插件使用|
...
|[技能代理数据(SKILL_PROXY)](module/ai/ai_tool/dataset/skill_proxy)|SKILL_PROXY|数据查询|否|[AIChatSkillDEDataSetRuntime](index/plugin_index#AIChatSkillDEDataSetRuntime)|插件使用|
|[启用的技能数据(SKILL_VALID)](module/ai/ai_tool/dataset/skill_valid)|SKILL_VALID|数据查询|否||插件使用|
