...
hide empty description
state "开始" as Begin <<start>> [[$./comment_counters#begin {"开始"}]]
state "统计知识库文档评论数" as RAWSQLCALL1  [[$./comment_counters#rawsqlcall1 {"统计知识库文档评论数"}]]
state "结束" as END1 <<end>> [[$./comment_counters#end1 {"结束"}]]
...
#### 统计知识库文档评论数 :id=RAWSQLCALL1<sup class="footnote-symbol"> <font color=gray size=1>[直接SQL调用]</font></sup>
