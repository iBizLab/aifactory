...
| --------   |------------| -----  | -----  | :----: | -------- |
|智能体标记|CONTEXT_CODE_NAME|外键值附加数据|30|是||
|智能体业务上下文标识|CONTEXT_ID|外键值|100|否||
|智能体上下文名称|CONTEXT_NAME|外键值附加数据|200|是||
|智能体系统标记|CONTEXT_SYSTEM_FLAG|外键值附加数据||是||
|创建人|CREATE_MAN|文本，可指定长度|100|否||
|创建时间|CREATE_TIME|日期时间型||否||
|deep_research|DEEP_RESEARCH|外键值附加数据||是||
|描述|DESCRIPTION|外键值附加数据|2000|是||
|标识<sup class="footnote-symbol"><font color=orange>[PK]</font></sup>|ID|全局唯一标识，文本类型，用户不可见|100|是||
|名称|NAME|外键值文本|200|否||
|启用增强目录召回|PAGE_INDEX|外键值附加数据||是||
|业务范围|SCOPES|[外键值附加数据](index/dictionary_index#ai_agent_context_scopes "智能体业务范围")|500|是||
|规格库标识|SPEC_KB_ID|外键值附加数据|100|是||
|系统标记|SYSTEM_FLAG|是否逻辑||是||
|更新人|UPDATE_MAN|文本，可指定长度|100|否||
|更新时间|UPDATE_TIME|日期时间型||否||
|全文推理|USE_FULLTEXT|外键值附加数据||是||
...
|[系统的(System)](module/ai/ai_agent_assignment/query/System)|System|否|否 |否 ||
|[默认（全部数据）(VIEW)](module/ai/ai_agent_assignment/query/View)|VIEW|否|否 |否 ||
|[bind](module/ai/ai_agent_assignment/query/bind)|bind|否|否 |否 ||

## 数据集合
| 中文名col200  | 代码名col150  | 类型col100 | 默认集合col100 |   插件col200|   备注col500|
| --------  | --------   | :----:   | :----:   | ----- |----- |
|[DEFAULT](module/ai/ai_agent_assignment/dataset/Default)|DEFAULT|数据查询|是|||
|[系统的(System)](module/ai/ai_agent_assignment/dataset/System)|System|数据查询|否|||
|[bind](module/ai/ai_agent_assignment/dataset/bind)|bind|数据查询|否|||
...
* `数据集合` ：[系统的(System)](module/ai/ai_agent_assignment#数据集合)
...
|N_NAME_LIKE|名称|LIKE||
|N_SCOPES_EQ|业务范围|EQ||
|N_SCOPES_LIKE|业务范围|LIKE||
|N_SCOPES_NOTEQ|业务范围|NOTEQ||
|N_USE_TAG_EQ|引用标记|EQ||

## 界面行为
|  中文名col200 |  代码名col150 |  标题col100   |     处理目标col100   |    处理类型col200        |  备注col500       |
| --------| --------| -------- |------------|------------|------------|
| 绑定 | bind | 绑定 |无数据|<details><summary>打开视图或向导（模态）</summary>[绑定智能体](app/view/ai_agent_context_bind_view)</details>|绑定智能体|
...
| 研究+无数据 | research_nodata | 研究 |无数据|<details><summary>打开视图或向导（模态）</summary>[智能体选择器](app/view/ai_agent_assignment_selector)</details>||
...
| 研究 | research | 研究 |单项数据|<details><summary>打开视图或向导（模态）</summary>[智能体选择器](app/view/ai_agent_assignment_selector)</details>||
