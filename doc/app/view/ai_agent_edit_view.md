# 智能体模板(ai_agent_edit_view)  <!-- {docsify-ignore-all} -->
...
### 关联界面行为
  * [智能体(AI_AGENT)](module/ai/ai_agent) : [编辑界面_拷贝操作](module/ai/ai_agent#界面行为)
  * [智能体(AI_AGENT)](module/ai/ai_agent) : [编辑界面_保存操作](module/ai/ai_agent#界面行为)
  * [智能体(AI_AGENT)](module/ai/ai_agent) : [编辑界面_删除并退出操作](module/ai/ai_agent#界面行为)
