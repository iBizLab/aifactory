...
* `onCreated`
```javascript
view.params.n_use_tag_eq=view.parentView.model.codeName+(view.params.deep_research == '1' ? '-dr' : '' );
...
### 关联界面行为
  * [智能体分配(AI_AGENT_ASSIGNMENT)](module/ai/ai_agent_assignment) : [智能创建](module/ai/ai_agent_assignment#界面行为)
...
### 关联视图
  ...
  * [绑定智能体(ai_agent_context_bind_view)](app/view/ai_agent_context_bind_view)
