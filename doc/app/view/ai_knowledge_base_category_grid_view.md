# 知识库(ai_knowledge_base_category_grid_view)  <!-- {docsify-ignore-all} -->
...
### 关联界面行为
  ...
  * [知识库(AI_KNOWLEDGE_BASE)](module/ai/ai_knowledge_base) : [表格界面_搜索栏](module/ai/ai_knowledge_base#界面行为)
  * [知识库(AI_KNOWLEDGE_BASE)](module/ai/ai_knowledge_base) : [打开新建知识库](module/ai/ai_knowledge_base#界面行为)
  * [知识库(AI_KNOWLEDGE_BASE)](module/ai/ai_knowledge_base) : [设置星标](module/ai/ai_knowledge_base#界面行为)
  * [知识库(AI_KNOWLEDGE_BASE)](module/ai/ai_knowledge_base) : [新建知识库](module/ai/ai_knowledge_base#界面行为)
...
### 关联视图
  ...
  * [新建知识库(ai_knowledge_base_create_wizard_view)](app/view/ai_knowledge_base_create_wizard_view)
