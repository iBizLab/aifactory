...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/sys_people/{key}/getsimple" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/sys_people/{key}/resetpassword" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`UPDATE`
...
|<el-row justify="space-between"><el-col :span="20">n_uid_eq</el-col><el-col :span="4" style="text-align:right"><el-text size="small" type="success">可选</el-text></el-col> </el-row>|String|uid/loginname|
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/sys_people/fetchuser" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
