# 动态数据看板(dyna_dashboard) :id=dyna_dashboard
## 创建动态数据看板
...
|<el-row justify="space-between"><el-col :span="20">example_chart</el-col><el-col :span="4" style="text-align:right"><el-text size="small" type="success">可选</el-text></el-col> </el-row>|String|示例图|
|<el-row justify="space-between"><el-col :span="20">sequences</el-col><el-col :span="4" style="text-align:right"><el-text size="small" type="success">可选</el-text></el-col> </el-row>|BigDecimal|序号|
...
|<el-row justify="space-between"><el-col :span="20">dyna_dashboard_name</el-col><el-col :span="4" style="text-align:right"><el-text size="small" type="success">可选</el-text></el-col> </el-row>|String|名称|
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/dyna_dashboards/{key}/move_order" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/dyna_dashboards/{key}/only_get" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/dyna_dashboards/{key}/use_cur_template" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`CREATE`
...
|<el-row justify="space-between"><el-col :span="20">n_dynadashboardname_eq</el-col><el-col :span="4" style="text-align:right"><el-text size="small" type="success">可选</el-text></el-col> </el-row>|String|名称|
...
|<el-row justify="space-between"><el-col :span="20">n_is_system_eq</el-col><el-col :span="4" style="text-align:right"><el-text size="small" type="success">可选</el-text></el-col> </el-row>|Integer|是否系统类型|
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/dyna_dashboards/fetch_example_chart" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/dyna_dashboards/fetch_normal" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
