...
|<el-row justify="space-between"><el-col :span="20">provider</el-col><el-col :span="4" style="text-align:right"><el-text size="small" type="success">可选</el-text></el-col> </el-row>|String|模型提供商标识|
...
|<el-row justify="space-between"><el-col :span="20">oss_image_vl_prompt</el-col><el-col :span="4" style="text-align:right"><el-text size="small" type="success">可选</el-text></el-col> </el-row>|String|图片文件解析提示词|
|<el-row justify="space-between"><el-col :span="20">provider_name</el-col><el-col :span="4" style="text-align:right"><el-text size="small" type="success">可选</el-text></el-col> </el-row>|String|模型提供商|
|<el-row justify="space-between"><el-col :span="20">access_token</el-col><el-col :span="4" style="text-align:right"><el-text size="small" type="success">可选</el-text></el-col> </el-row>|String|access_token|
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/ai_models/{key}/generate_provider_model" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`CREATE`
...
|<el-row justify="space-between"><el-col :span="20">n_code_name_eq</el-col><el-col :span="4" style="text-align:right"><el-text size="small" type="success">可选</el-text></el-col> </el-row>|String|模型标识|
...
|<el-row justify="space-between"><el-col :span="20">n_model_category_in</el-col><el-col :span="4" style="text-align:right"><el-text size="small" type="success">可选</el-text></el-col> </el-row>|String|模型类别|
...
|<el-row justify="space-between"><el-col :span="20">n_provider_eq</el-col><el-col :span="4" style="text-align:right"><el-text size="small" type="success">可选</el-text></el-col> </el-row>|String|模型提供商标识|
|<el-row justify="space-between"><el-col :span="20">n_provider_name_eq</el-col><el-col :span="4" style="text-align:right"><el-text size="small" type="success">可选</el-text></el-col> </el-row>|String|模型提供商|
|<el-row justify="space-between"><el-col :span="20">n_provider_name_like</el-col><el-col :span="4" style="text-align:right"><el-text size="small" type="success">可选</el-text></el-col> </el-row>|String|模型提供商|
...
```json
{
  ...
  "n_model_category_in" : null,
  "n_name_like" : null,
  "n_provider_eq" : null,
  "n_provider_name_eq" : null,
  "n_provider_name_like" : null,
}
```
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/ai_models/fetch_provider_model_version" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
