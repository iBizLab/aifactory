...
|<el-row justify="space-between"><el-col :span="20">skill_references</el-col><el-col :span="4" style="text-align:right"><el-text size="small" type="success">可选</el-text></el-col> </el-row>|Object|技能引用资料|
|<el-row justify="space-between"><el-col :span="20">skill_scripts</el-col><el-col :span="4" style="text-align:right"><el-text size="small" type="success">可选</el-text></el-col> </el-row>|Object|技能脚本集合|
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/ai_tools/create_skill" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`CREATE`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/ai_tools/fetch_extension_mcp_server" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/ai_tools/fetch_skill_proxy" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
插件使用
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/ai_tools/fetch_skill_valid" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
插件使用
