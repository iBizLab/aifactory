...
|<el-row justify="space-between"><el-col :span="20">access_key</el-col><el-col :span="4" style="text-align:right"><el-text size="small" type="success">可选</el-text></el-col> </el-row>|String|Access Key|
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/ai_credentials/fetch_ac" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
...
|<el-row justify="space-between"><el-col :span="20">n_provider_eq</el-col><el-col :span="4" style="text-align:right"><el-text size="small" type="success">可选</el-text></el-col> </el-row>|String|模型提供商|
