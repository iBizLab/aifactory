...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/spaces/create_corresponding_kb" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`CREATE`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/spaces/mark_main_space" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`UPDATE`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/spaces/other_re_space" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`UPDATE`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/spaces/recognize_cur_user_role" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/spaces/fetch_mob_main" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
